...
from .class_names import (ade_classes, ade_palette, bdd100k_classes,
                          ...
                          loveda_classes, loveda_palette, poquets_classes,
                          poquets_palette, potsdam_classes, potsdam_palette,
                          stare_classes, stare_palette, synapse_classes,
                          synapse_palette, vaihingen_classes,
